...
;	contador_ equ 92
	Hab_rx equ   93  ;con 0 recive distinto de cero no recive
...
;iniciializaciones
mov Hab_rx,#0FFh ;No recibe comunicacion serial
...
push acc
	...
	jmp fin_serie
Rxon:	
  mov a,Hab_rx   ;con cero en recive entra a recepcion
...
mov Hab_rx,#0FFh ; Habilita recibe comunicacion serial
mov r0,#START_SEN
;mov r2,Largo_data
;mov Largo_data,#010H
mov Largo_data,#0FH
...
;mov sbuf,ValorLRC 
;
mov Hab_rx,#0FFh ; DEsHabilita ecibe comunicacion serial
