...
LOOP_1:
	...
	jb CARD_PRESENT,LOOP  ;SI baja el card prersent va a leyendo tarjeta
		jmp READING	 
;    			mov a,Pagando ;Pagando/contando tikerts fisicos
...
mov Contador_retardoh,#02H ;;low: 08H Hig:02H t= 0,25ms
call  RETARDO_0xms
cpl CLKled 
mov Contador_retardol,#02H ;low: 08H Hig:02H t= 0,25ms
mov Contador_retardoh,#08H ;low: 08H Hig:02H t= 0,25ms
call  RETARDO_0xms
...
COIN_CORTO:
	mov Contador_retardo_coin_l,#07FH ;low: 0FEH Hig:030H t= 65ms
	mov Contador_retardo_coin_h,#030H ;low: 0FEH Hig:030H t= 65ms
   jmp SETEO_PAGO
